                                ...
                                <div class="row gx-7">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="tpform__input mb-20">
                                            <input class="@error('phone_number') is-invalid @enderror" type="number" placeholder="Phone" name="phone_number" id="phone_number">
                                            @error('phone_number')
                                                <div class="invalid-feedback">
                                                    {{$message}}
                                                </div>
                                    ...
                                    <div class="col-lg-12 mb-20">
                                        <div class="tpform__input">
                                            ...
                                            <div class="input-group date" id="dt-enab-disab-date" data-target-input="nearest">
                                                <input id="start_booking_date" class="@error('start_booking_date') is-invalid @enderror form-control datetimepicker-input digits" type="text" name="start_booking_date" data-target="#dt-enab-disab-date">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="tpform__input">
                                            ...
                                            <div class="input-group date" id="dt-enab-disab-date-end" data-target-input="nearest">
                                                <input class="@error('end_booking_date') is-invalid @enderror form-control datetimepicker-input digits" type="text" name="end_booking_date" id="end_booking_date" data-target="#dt-enab-disab-date-end">
